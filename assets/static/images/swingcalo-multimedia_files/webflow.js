...
module.exports = function($, _) {
  ...
  var designer;
  var inApp = Webflow.env();
  var namespace = '.swingcalo-dropdown';
  var stateOpen = 'swingcalo--open';
  var closeEvent = 'swingcalo-close' + namespace;
  ...
  function build(i, el) {
    ...
    data.list = $el.children('.swingcalo-dropdown-list');
    data.toggle = $el.children('.swingcalo-dropdown-toggle');
    data.links = data.list.children('.swingcalo-dropdown-link');
    ...
    data.nav = $el.closest('.swingcalo-nav');
  ...
  function outside(data) {
    ...
    return _.debounce(function(evt) {
      ...
      if ($target.closest('.swingcalo-dropdown-toggle').length) return;
...
module.exports = function($, _) {
  ...
  function build(i, el) {
    ...
    reset(data);
    var wrap = $el.closest('div.swingcalo-form');
    data.done = wrap.find('> .swingcalo-form-done');
    data.fail = wrap.find('> .swingcalo-form-fail');
  ...
  function afterSubmit(data) {
    var form = data.form;
    var wrap = form.closest('div.swingcalo-form');
...
module.exports = function($, _) {
  ...
  function init() {
    $doc.find('.swingcalo-widget-gplus').length && load();
  }
...
module.exports = function($, _) {
  ...
  var designer;
  var $win = $(window);
  var namespace = '.swingcalo-ix';
  var tram = $.tram;
  var env = Webflow.env;
  var inApp = env();
  var emptyFix = env.chrome && env.chrome < 35;
  var transNone = 'none 0s ease 0s';
  var introEvent = 'swingcalo-ix-intro' + namespace;
  var outroEvent = 'swingcalo-ix-outro' + namespace;
  ...
  var components = {
    tabs: '.swingcalo-tab-link, .swingcalo-tab-pane',
    dropdown: '.swingcalo-dropdown',
    slider: '.swingcalo-slide',
    navbar: '.swingcalo-nav'
  };
  ...
  function run(trigger, $el, opts, replay) {
    ...
    if (!replay) {
      ...
      if (emptyFix) $el.addClass('swingcalo-ix-emptyfix');
    }
...
function createLightbox(window, document, $, undefined) {
  ...
  var namespace = 'swingcalo-lightbox';
  ...
  (function () {
    ...
    function refresh() {
      ...
      var content =
        '.swingcalo-lightbox-content, .swingcalo-lightbox-view, .swingcalo-lightbox-view:before {' +
          'height:' + vh + 'px' +
        '}' +
        '.swingcalo-lightbox-view {' +
          'width:' + vw + 'px' +
        '}' +
        '.swingcalo-lightbox-group, .swingcalo-lightbox-group .swingcalo-lightbox-view, .swingcalo-lightbox-group .swingcalo-lightbox-view:before {' +
          'height:' + (0.86 * vh) + 'px' +
        '}' +
        '.swingcalo-lightbox-image {' +
          'max-width:' + vw + 'px;' +
          'max-height:' + vh + 'px' +
        '}' +
        '.swingcalo-lightbox-group .swingcalo-lightbox-image {' +
          'max-height:' + (0.86 * vh) + 'px' +
        '}' +
        '.swingcalo-lightbox-strip {' +
          'padding: 0 ' + (0.01 * vh) + 'px' +
        '}' +
        '.swingcalo-lightbox-item {' +
          'width:' + (0.1 * vh) + 'px;' +
          'padding:' + (0.02 * vh) + 'px ' + (0.01 * vh) + 'px' +
        '}' +
        '.swingcalo-lightbox-thumbnail {' +
          'height:' + (0.1 * vh) + 'px' +
        '}' +
...
module.exports = function($, _) {
  ...
  function configure(data) {
    var json = data.el.children('.swingcalo-json').html();
...
module.exports = function($, _) {
  ...
  var linkCurrent = 'swingcalo--current';
...
module.exports = function($, _) {
  ...
  var google = null;
  var $maps;
  var namespace = '.swingcalo-widget-map';
  ...
  var store = 'swingcalo-widget-map';
...
module.exports = function($, _) {
  ...
  var designer;
  var inApp = Webflow.env();
  var overlay = '<div class="swingcalo-nav-overlay" data-wf-ignore />';
  var namespace = '.swingcalo-nav';
  var buttonOpen = 'swingcalo--open';
  var menuOpen = 'swingcalo--nav-menu-open';
  var linkOpen = 'swingcalo--nav-link-open';
  var ix = Webflow.ixEvents();
  ...
  function build(i, el) {
    ...
    var data = $.data(el, namespace);
    if (!data) data = $.data(el, namespace, { open: false, el: $el, config: {} });
    data.menu = $el.find('.swingcalo-nav-menu');
    data.links = data.menu.find('.swingcalo-nav-link');
    data.dropdowns = data.menu.find('.swingcalo-dropdown');
    data.button = $el.find('.swingcalo-nav-button');
    data.container = $el.find('.swingcalo-container');
    data.outside = outside(data);
  ...
  function outside(data) {
    ...
    return _.debounce(function(evt) {
      if (!data.open) return;
      var menu = $(evt.target).closest('.swingcalo-nav-menu');
  ...
  function close(data, immediate) {
    ...
    function complete() {
      ...
      data.el.triggerHandler('swingcalo-close');
    }
  }
...
module.exports = function($, _) {
  ...
  function findEl(hash, e) {
    ...
    var header = $('header, body > .header, body > .swingcalo-nav:not([data-no-scroll])');
...
module.exports = function($, _) {
  ...
  var designer;
  var inApp = Webflow.env();
  var namespace = '.swingcalo-slider';
  var dot = '<div class="swingcalo-slider-dot" data-wf-ignore />';
  var ix = Webflow.ixEvents();
  var fallback;
  var redraw;
  ...
  function build(i, el) {
    ...
    data.mask = $el.children('.swingcalo-slider-mask');
    data.left = $el.children('.swingcalo-slider-arrow-left');
    data.right = $el.children('.swingcalo-slider-arrow-right');
    data.nav = $el.children('.swingcalo-slider-nav');
    data.slides = data.mask.children('.swingcalo-slide');
  ...
  function change(data, options) {
    ...
    // Select page nav
    var active = data.nav.children().eq(data.index).addClass('swingcalo-active');
    data.nav.children().not(active).removeClass('swingcalo-active');
  ...
  function buildNav(data) {
    ...
    for (var i=0; i<data.pages; i++) {
      $dot = $(dot);
      if (data.nav.hasClass('swingcalo-num')) $dot.text(i+1);
...
module.exports = function($, _) {
  ...
  var inApp = env();
  var tabAttr = 'data-swingcalo-tab';
  var namespace = '.swingcalo-tabs';
  var linkCurrent = 'swingcalo--current';
  var tabActive = 'swingcalo--tab-active';
  var ix = Webflow.ixEvents();
  ...
  function build(i, el) {
    ...
    data.current = null;
    data.menu = $el.children('.swingcalo-tab-menu');
    data.links = data.menu.children('.swingcalo-tab-link');
    data.content = $el.children('.swingcalo-tab-content');
    data.panes = data.content.children('.swingcalo-tab-pane');
